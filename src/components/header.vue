	...
	<header class="header">
        ...
        <div class="navbar">
          <div class="navbar-left-container">
            <a href="/">
              <img class="navbar-brand-logo" src="../../static/h-1.jpg" width="200" height="80"></a>
          </div>
            			...
            			<div class="confirm-tips">
            				...
            				<ul>
            					<li class="regi_form_input">
            						...
            						<input type="text"  tabindex="1" class="regi_login_input regi_login_input_left" name="loginname" v-model="userName" placeholder="请输入用户名"/>
            					</li>
            					<li class="regi_form_input noMargin">
            						<i class="icon IconPwd"></i>
            						<input type="password"  tabindex="2" class="regi_login_input regi_login_input_left" name="password" v-model="userPwd" placeholder="请输入密码" @keyup.enter="login"/>
            					</li>
            				</ul>
            			</div>
