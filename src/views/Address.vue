<template>
	...
	<div class="checkout-page">
        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item, index) in addressListFilter" :class="{'check':checkIndex==index}" @click="selectAdd(item,index)">
                    <dl>
                      <dt>{{item.userName}}</dt>
            ...
            <div class="next-btn-wrap">
              ...
              <router-link class="btn btn--m btn--red" href="javascript:;" :to="{path:'OrderConfirm',query:{'addressId':selectedAddrId}}">Next</router-link>
            </div>
          </div>
        </div>
      </div>
      <modal :mdshow="isMdShow" @close="closeModal">
      	...
      	<div slot="btnGroup">
      		<a href="javascript:;" class="btn btn--m" @click="delAddress" style="width: 48%;">确认</a>
      		<a href="javascript:;" class="btn btn--m" @click="isMdShow=false" style="width: 48%;">取消</a>
      	</div>
      </modal>
