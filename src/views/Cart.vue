  ...
  <div>
    ...
    <modal :mdshow="modalConfirm" @close="closeModel">
    	...
    	<div slot="btnGroup" style="width: 100%;">
      		<a href="javascript:;" class="btn btn--m" @click="delCart" style="width: 48%;">确认</a>
      		<a href="javascript:;" class="btn btn--m" @click="modalConfirm=false" style="width: 48%;">取消</a>
      	</div>
    </modal>
